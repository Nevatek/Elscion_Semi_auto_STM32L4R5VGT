...
static NexButton bBack = NexButton(en_WinId_LampReplaceLogin , 1, "b5");
static NexButton bEnter = NexButton(en_WinId_LampReplaceLogin , 7, "b1");

static NexText tEnteredPassword = NexText(en_WinId_LampReplaceLogin, 4 , "t1");
...
void HandlerbEnter(void *ptr)
{
	...
	{
		ChangeWindowPage(en_WinId_Diag_Lamp , (enWindowID)NULL);
	}
	else
	{
