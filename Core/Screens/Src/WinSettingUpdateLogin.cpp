...
static NexButton bBack = NexButton(en_WinId_UpdateLogin , 1, "b5");
static NexButton bProceed = NexButton(en_WinId_UpdateLogin, 7 , "b1");
static NexText tPassword = NexText(en_WinId_UpdateLogin, 4 , "t1");
