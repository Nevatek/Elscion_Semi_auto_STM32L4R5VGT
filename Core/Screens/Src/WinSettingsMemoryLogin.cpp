...
static NexButton bBack = NexButton(en_WinId_ClearMemoryLogin , 1, "b5");
static NexButton bEnter = NexButton(en_WinId_ClearMemoryLogin , 7, "b1");

static NexText tEnteredPassword = NexText(en_WinId_ClearMemoryLogin, 4 , "t1");
...
void HandlerbEnter(void *ptr)
{
	...
	{
		ChangeWindowPage(en_WinId_SettingsMemory , (enWindowID)NULL);
	}
	else
	{
