...
uint32_t W25qxx_GetBlockSize(void)
{
	return w25qxx.BlockSize;
}
uint32_t W25qxx_GetSectorSize(void)
{
...
{
	W25qxx_EraseBlock(Block_Address);/*10/03/2023*/
